...
plot(dates, prices, ticker, title='Log-Prices Over Time')
plot(dates, log_price, ticker, title='Log-Prices Over Time')
...
plt.plot(dates, preds_training_poly)
plt.title(f'{ticker} {degree}th Degree Fit')
plt.xlabel('Date')
plt.ylabel('Closing Price')
plt.show()
